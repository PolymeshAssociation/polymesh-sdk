...
export class Polymesh {
   ...
   *
   * @param args.ticker - ticker symbol to claim
   * @param args.ethereumSignature - signature generated by signing a message formed by the DID (hex without the leading 0x),
