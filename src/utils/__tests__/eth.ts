...
describe('eth utils', () => {
  ...
  describe('assetIdToPrecompileAddress', () => {
    ...
    it('should lay out the Asset ID, the fungible precompile id and the reserved bytes', () => {
      expect(assetIdToPrecompileAddress(assetId, 'fungible')).toBe(
        '0x1234567890abcdEF1234567890aBCdeF00080000'
      );
    });

    it('should lay out the Asset ID, the non-fungible precompile id and the reserved bytes', () => {
