...
export default {
  ...
  /**
   * Lookup635: pallet_pips::Pip<polymesh_runtime_ci::runtime::Call, sp_core::crypto::AccountId32>
   **/
  PalletPipsPip: {
    id: 'u32',
    proposal: 'Call',
  ...
  /**
   * Lookup650: pallet_scheduler::ScheduledV3<frame_support::traits::schedule::MaybeHashed<polymesh_runtime_ci::runtime::Call, primitive_types::H256>, BlockNumber, polymesh_runtime_ci::runtime::OriginCaller, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup651: polymesh_runtime_ci::runtime::OriginCaller
   **/
  ...
  /**
   * Lookup715: polymesh_runtime_ci::runtime::Runtime
   **/
