...
export enum IdentityTx {
  ...
  RemoveSecondaryAccounts = 'identity.removeSecondaryAccounts',
  AcceptPrimaryAccount = 'identity.acceptPrimaryAccount',
  ChangeCddRequirementForMkRotation = 'identity.changeCddRequirementForMkRotation',
  JoinIdentityAsAccount = 'identity.joinIdentityAsAccount',
  LeaveIdentityAsAccount = 'identity.leaveIdentityAsAccount',
  ...
  FreezeSecondaryAccounts = 'identity.freezeSecondaryAccounts',
  UnfreezeSecondaryAccounts = 'identity.unfreezeSecondaryAccounts',
  AddAuthorization = 'identity.addAuthorization',
  RemoveAuthorization = 'identity.removeAuthorization',
  AddSecondaryAccountsWithAuthorization = 'identity.addSecondaryAccountsWithAuthorization',
  ...
  RotatePrimaryAccountToSecondary = 'identity.rotatePrimaryAccountToSecondary',
}
