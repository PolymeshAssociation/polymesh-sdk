...
declare module '@polkadot/api/types/storage' {
  export interface AugmentedQueries<ApiType> {
    asset: {
       ...
       **/
      aggregateBalance: AugmentedQueryDoubleMap<ApiType, (key1: Ticker | string | Uint8Array, key2: ScopeId | string | Uint8Array) => Observable<Balance>, [Ticker, ScopeId]>;
      /**
       * Documents attached to an Asset
       * (ticker, doc_id) -> document
       **/
      assetDocuments: AugmentedQueryDoubleMap<ApiType, (key1: Ticker | string | Uint8Array, key2: DocumentId | AnyNumber | Uint8Array) => Observable<Document>, [Ticker, DocumentId]>;
      /**
       * Per-ticker document ID counter.
       * (ticker) -> doc_id
       **/
      assetDocumentsIdSequence: AugmentedQuery<ApiType, (arg: Ticker | string | Uint8Array) => Observable<DocumentId>, [Ticker]>;
      /**
       * Tickers and token owned by a user
       * (user, ticker) -> AssetOwnership
       **/
      assetOwnershipRelations: AugmentedQueryDoubleMap<ApiType, (key1: IdentityId | string | Uint8Array, key2: Ticker | string | Uint8Array) => Observable<AssetOwnershipRelation>, [IdentityId, Ticker]>;
      /**
       * The total asset ticker balance per identity.
       * (ticker, DID) -> Balance
       **/
      balanceOf: AugmentedQueryDoubleMap<ApiType, (key1: Ticker | string | Uint8Array, key2: IdentityId | string | Uint8Array) => Observable<Balance>, [Ticker, IdentityId]>;
      /**
       ...
       **/
      balanceOfAtScope: AugmentedQueryDoubleMap<ApiType, (key1: ScopeId | string | Uint8Array, key2: IdentityId | string | Uint8Array) => Observable<Balance>, [ScopeId, IdentityId]>;
      /**
       * Ticker registration details on Polymath Classic / Ethereum.
       **/
      classicTickers: AugmentedQuery<ApiType, (arg: Ticker | string | Uint8Array) => Observable<Option<ClassicTickerRegistration>>, [Ticker]>;
      /**
       * Supported extension version.
       **/
      compatibleSmartExtVersion: AugmentedQuery<ApiType, (arg: SmartExtensionType | { TransferManager: any } | { Offerings: any } | { SmartWallet: any } | { Custom: any } | string | Uint8Array) => Observable<ExtVersion>, [SmartExtensionType]>;
      /**
       * List of Smart extension added for the given tokens.
       * ticker, AccountId (SE address) -> SmartExtension detail
       **/
      extensionDetails: AugmentedQuery<ApiType, (arg: ITuple<[Ticker, AccountId]> | [Ticker | string | Uint8Array, AccountId | string | Uint8Array]) => Observable<SmartExtension>, [ITuple<[Ticker, AccountId]>]>;
      /**
       * List of Smart extension added for the given tokens and for the given type.
       * ticker, type of SE -> address/AccountId of SE
       **/
      extensions: AugmentedQuery<ApiType, (arg: ITuple<[Ticker, SmartExtensionType]> | [Ticker | string | Uint8Array, SmartExtensionType | { TransferManager: any } | { Offerings: any } | { SmartWallet: any } | { Custom: any } | string | Uint8Array]) => Observable<Vec<AccountId>>, [ITuple<[Ticker, SmartExtensionType]>]>;
      /**
       * The set of frozen assets implemented as a membership map.
       * ticker -> bool
       **/
      frozen: AugmentedQuery<ApiType, (arg: Ticker | string | Uint8Array) => Observable<bool>, [Ticker]>;
      /**
       * The name of the current funding round.
       * ticker -> funding round
       **/
      fundingRound: AugmentedQuery<ApiType, (arg: Ticker | string | Uint8Array) => Observable<FundingRoundName>, [Ticker]>;
      /**
       * A map of a ticker name and asset identifiers.
       **/
      identifiers: AugmentedQuery<ApiType, (arg: Ticker | string | Uint8Array) => Observable<Vec<AssetIdentifier>>, [Ticker]>;
      /**
       * The total balances of tokens issued in all recorded funding rounds.
       * (ticker, funding round) -> balance
       **/
      issuedInFundingRound: AugmentedQuery<ApiType, (arg: ITuple<[Ticker, FundingRoundName]> | [Ticker | string | Uint8Array, FundingRoundName | string]) => Observable<Balance>, [ITuple<[Ticker, FundingRoundName]>]>;
      /**
       * Tracks the ScopeId of the identity for a given ticker.
       * (Ticker, IdentityId) => ScopeId.
       **/
      scopeIdOf: AugmentedQueryDoubleMap<ApiType, (key1: Ticker | string | Uint8Array, key2: IdentityId | string | Uint8Array) => Observable<ScopeId>, [Ticker, IdentityId]>;
      /**
       * Storage version.
       **/
       ...
       **/
      tickers: AugmentedQuery<ApiType, (arg: Ticker | string | Uint8Array) => Observable<TickerRegistration>, [Ticker]>;
      /**
       * Details of the token corresponding to the token ticker.
       * (ticker) -> SecurityToken details [returns SecurityToken struct]
       **/
      tokens: AugmentedQuery<ApiType, (arg: Ticker | string | Uint8Array) => Observable<SecurityToken>, [Ticker]>;
    };
    authorship: {
      /**
    ...
    bridge: {
       ...
       **/
      bridgeLimitExempted: AugmentedQuery<ApiType, (arg: IdentityId | string | Uint8Array) => Observable<bool>, [IdentityId]>;
      /**
       * Details of bridge transactions identified with pairs of the recipient account and the
       * bridge transaction nonce.
       **/
      bridgeTxDetails: AugmentedQueryDoubleMap<ApiType, (key1: AccountId | string | Uint8Array, key2: u32 | AnyNumber | Uint8Array) => Observable<BridgeTxDetail>, [AccountId, u32]>;
      /**
       ...
       **/
      polyxBridged: AugmentedQuery<ApiType, (arg: IdentityId | string | Uint8Array) => Observable<ITuple<[Balance, BlockNumber]>>, [IdentityId]>;
      /**
       * Storage version.
       **/
      storageVersion: AugmentedQuery<ApiType, () => Observable<Version>, []>;
    ...
    capitalDistribution: {
       ...
       * (CAId) => Distribution
       **/
      distributions: AugmentedQuery<ApiType, (arg: CAId | { ticker?: any; local_id?: any } | string | Uint8Array) => Observable<Option<Distribution>>, [CAId]>;
      /**
       * Has an asset holder been paid yet?
       * 
       * (CAId, DID) -> Was DID paid in the CAId?
       **/
      holderPaid: AugmentedQuery<ApiType, (arg: ITuple<[CAId, IdentityId]> | [CAId | { ticker?: any; local_id?: any } | string | Uint8Array, IdentityId | string | Uint8Array]) => Observable<bool>, [ITuple<[CAId, IdentityId]>]>;
      /**
       * Storage version.
       **/
      storageVersion: AugmentedQuery<ApiType, () => Observable<Version>, []>;
    ...
    checkpoint: {
       ...
       **/
      balance: AugmentedQueryDoubleMap<ApiType, (key1: ITuple<[Ticker, CheckpointId]> | [Ticker | string | Uint8Array, CheckpointId | AnyNumber | Uint8Array], key2: IdentityId | string | Uint8Array) => Observable<Balance>, [ITuple<[Ticker, CheckpointId]>, IdentityId]>;
      /**
       * Checkpoints where a DID's balance was updated.
       * (ticker, did) -> [checkpoint ID where user balance changed]
       **/
      balanceUpdates: AugmentedQueryDoubleMap<ApiType, (key1: Ticker | string | Uint8Array, key2: IdentityId | string | Uint8Array) => Observable<Vec<CheckpointId>>, [Ticker, IdentityId]>;
      /**
       ...
       **/
      checkpointIdSequence: AugmentedQuery<ApiType, (arg: Ticker | string | Uint8Array) => Observable<CheckpointId>, [Ticker]>;
      /**
       * Checkpoint schedule ID sequence for tickers.
       * 
       * (ticker) -> schedule ID
       **/
      scheduleIdSequence: AugmentedQuery<ApiType, (arg: Ticker | string | Uint8Array) => Observable<ScheduleId>, [Ticker]>;
      /**
       * All the checkpoints a given schedule originated.
       * 
       * (ticker, schedule ID) -> [checkpoint ID]
       **/
      schedulePoints: AugmentedQueryDoubleMap<ApiType, (key1: Ticker | string | Uint8Array, key2: ScheduleId | AnyNumber | Uint8Array) => Observable<Vec<CheckpointId>>, [Ticker, ScheduleId]>;
      /**
       ...
       **/
      scheduleRefCount: AugmentedQueryDoubleMap<ApiType, (key1: Ticker | string | Uint8Array, key2: ScheduleId | AnyNumber | Uint8Array) => Observable<u32>, [Ticker, ScheduleId]>;
      /**
       * Checkpoint schedules for tickers.
       * 
       * (ticker) -> [schedule]
       **/
      schedules: AugmentedQuery<ApiType, (arg: Ticker | string | Uint8Array) => Observable<Vec<StoredSchedule>>, [Ticker]>;
      /**
       ...
       **/
      timestamps: AugmentedQueryDoubleMap<ApiType, (key1: Ticker | string | Uint8Array, key2: CheckpointId | AnyNumber | Uint8Array) => Observable<Moment>, [Ticker, CheckpointId]>;
      /**
       * Total supply of the token at the checkpoint.
       * 
       * (ticker, checkpointId) -> total supply at given checkpoint
       **/
      totalSupply: AugmentedQueryDoubleMap<ApiType, (key1: Ticker | string | Uint8Array, key2: CheckpointId | AnyNumber | Uint8Array) => Observable<Balance>, [Ticker, CheckpointId]>;
    };
    committeeMembership: {
      /**
       * The current "active" membership, stored as an ordered Vec.
    ...
    complianceManager: {
       ...
       **/
      assetCompliances: AugmentedQuery<ApiType, (arg: Ticker | string | Uint8Array) => Observable<AssetCompliance>, [Ticker]>;
      /**
       * Storage version.
       **/
      storageVersion: AugmentedQuery<ApiType, () => Observable<Version>, []>;
       ...
       **/
      trustedClaimIssuer: AugmentedQuery<ApiType, (arg: Ticker | string | Uint8Array) => Observable<Vec<TrustedIssuer>>, [Ticker]>;
    };
    contracts: {
      /**
       ...
       **/
      extensionInfo: AugmentedQuery<ApiType, (arg: AccountId | string | Uint8Array) => Observable<ExtensionAttributes>, [AccountId]>;
      /**
       ...
       **/
      metadataOfTemplate: AugmentedQuery<ApiType, (arg: CodeHash | string | Uint8Array) => Observable<TemplateMetadata>, [CodeHash]>;
      /**
       * Store the details of the template (Ex- owner, frozen etc).
       **/
      templateInfo: AugmentedQuery<ApiType, (arg: CodeHash | string | Uint8Array) => Observable<TemplateDetails>, [CodeHash]>;
    };
    corporateAction: {
      /**
       ...
       **/
      caDocLink: AugmentedQuery<ApiType, (arg: CAId | { ticker?: any; local_id?: any } | string | Uint8Array) => Observable<Vec<DocumentId>>, [CAId]>;
      /**
       * The next per-`Ticker` CA ID in the sequence.
       * The full ID is defined as a combination of `Ticker` and a number in this sequence.
       **/
      caIdSequence: AugmentedQuery<ApiType, (arg: Ticker | string | Uint8Array) => Observable<LocalCAId>, [Ticker]>;
      /**
       ...
       **/
      corporateActions: AugmentedQueryDoubleMap<ApiType, (key1: Ticker | string | Uint8Array, key2: LocalCAId | AnyNumber | Uint8Array) => Observable<Option<CorporateAction>>, [Ticker, LocalCAId]>;
      /**
       ...
       **/
      defaultTargetIdentities: AugmentedQuery<ApiType, (arg: Ticker | string | Uint8Array) => Observable<TargetIdentities>, [Ticker]>;
      /**
       ...
       * (ticker => % to withhold)
       **/
      defaultWithholdingTax: AugmentedQuery<ApiType, (arg: Ticker | string | Uint8Array) => Observable<Tax>, [Ticker]>;
      /**
       ...
       **/
      didWithholdingTax: AugmentedQuery<ApiType, (arg: Ticker | string | Uint8Array) => Observable<Vec<ITuple<[IdentityId, Tax]>>>, [Ticker]>;
      /**
    ...
    corporateBallot: {
       ...
       * (CAId) => BallotMeta
       **/
      metas: AugmentedQuery<ApiType, (arg: CAId | { ticker?: any; local_id?: any } | string | Uint8Array) => Observable<Option<BallotMeta>>, [CAId]>;
      /**
       ...
       **/
      motionNumChoices: AugmentedQuery<ApiType, (arg: CAId | { ticker?: any; local_id?: any } | string | Uint8Array) => Observable<Vec<u16>>, [CAId]>;
      /**
       ...
       * (CAId) => bool
       **/
      rcv: AugmentedQuery<ApiType, (arg: CAId | { ticker?: any; local_id?: any } | string | Uint8Array) => Observable<bool>, [CAId]>;
      /**
       ...
       **/
      results: AugmentedQuery<ApiType, (arg: CAId | { ticker?: any; local_id?: any } | string | Uint8Array) => Observable<Vec<Balance>>, [CAId]>;
      /**
       ...
       **/
      timeRanges: AugmentedQuery<ApiType, (arg: CAId | { ticker?: any; local_id?: any } | string | Uint8Array) => Observable<Option<BallotTimeRange>>, [CAId]>;
      /**
       ...
       **/
      votes: AugmentedQueryDoubleMap<ApiType, (key1: CAId | { ticker?: any; local_id?: any } | string | Uint8Array, key2: IdentityId | string | Uint8Array) => Observable<Vec<BallotVote>>, [CAId, IdentityId]>;
    };
    externalAgents: {
      /**
       ...
       **/
      agIdSequence: AugmentedQuery<ApiType, (arg: Ticker | string | Uint8Array) => Observable<AGId>, [Ticker]>;
      /**
       * Maps agents (`IdentityId`) for a `Ticker` to what AG they belong to, if any.
       **/
      groupOfAgent: AugmentedQueryDoubleMap<ApiType, (key1: Ticker | string | Uint8Array, key2: IdentityId | string | Uint8Array) => Observable<Option<AgentGroup>>, [Ticker, IdentityId]>;
      /**
       * For custom AGs of a `Ticker`, maps to what permissions an agent in that AG would have.
       **/
      groupPermissions: AugmentedQueryDoubleMap<ApiType, (key1: Ticker | string | Uint8Array, key2: AGId | AnyNumber | Uint8Array) => Observable<Option<ExtrinsicPermissions>>, [Ticker, AGId]>;
      /**
       * Maps a `Ticker` to the number of `Full` agents for it.
       **/
      numFullAgents: AugmentedQuery<ApiType, (arg: Ticker | string | Uint8Array) => Observable<u32>, [Ticker]>;
    };
    grandpa: {
      /**
    ...
    identity: {
       ...
       **/
      authorizations: AugmentedQueryDoubleMap<ApiType, (key1: Signatory | { Identity: any } | { Account: any } | string | Uint8Array, key2: u64 | AnyNumber | Uint8Array) => Observable<Authorization>, [Signatory, u64]>;
      /**
       * All authorizations that an identity has given. (Authorizer, auth_id -> authorized)
       **/
      authorizationsGiven: AugmentedQueryDoubleMap<ApiType, (key1: IdentityId | string | Uint8Array, key2: u64 | AnyNumber | Uint8Array) => Observable<Signatory>, [IdentityId, u64]>;
      /**
       ...
       **/
      claims: AugmentedQueryDoubleMap<ApiType, (key1: Claim1stKey | { target?: any; claim_type?: any } | string | Uint8Array, key2: Claim2ndKey | { issuer?: any; scope?: any } | string | Uint8Array) => Observable<IdentityClaim>, [Claim1stKey, Claim2ndKey]>;
      /**
       ...
       * DID -> identity info
       **/
      didRecords: AugmentedQuery<ApiType, (arg: IdentityId | string | Uint8Array) => Observable<DidRecord>, [IdentityId]>;
      /**
       * DID -> bool that indicates if secondary keys are frozen.
       **/
      isDidFrozen: AugmentedQuery<ApiType, (arg: IdentityId | string | Uint8Array) => Observable<bool>, [IdentityId]>;
      keyToIdentityIds: AugmentedQuery<ApiType, (arg: AccountId | string | Uint8Array) => Observable<IdentityId>, [AccountId]>;
      /**
       ...
       **/
      offChainAuthorizationNonce: AugmentedQuery<ApiType, (arg: IdentityId | string | Uint8Array) => Observable<AuthorizationNonce>, [IdentityId]>;
      /**
       * Inmediate revoke of any off-chain authorization.
       **/
      revokeOffChainAuthorization: AugmentedQuery<ApiType, (arg: ITuple<[Signatory, TargetIdAuthorization]> | [Signatory | { Identity: any } | { Account: any } | string | Uint8Array, TargetIdAuthorization | { target_id?: any; nonce?: any; expires_at?: any } | string | Uint8Array]) => Observable<bool>, [ITuple<[Signatory, TargetIdAuthorization]>]>;
      /**
       * Storage version.
       **/
      storageVersion: AugmentedQuery<ApiType, () => Observable<Version>, []>;
    ...
    multiSig: {
       ...
       **/
      keyToMultiSig: AugmentedQuery<ApiType, (arg: AccountId | string | Uint8Array) => Observable<AccountId>, [AccountId]>;
      /**
       ...
       **/
      multiSigSigners: AugmentedQueryDoubleMap<ApiType, (key1: AccountId | string | Uint8Array, key2: Signatory | { Identity: any } | { Account: any } | string | Uint8Array) => Observable<Signatory>, [AccountId, Signatory]>;
      /**
       * Confirmations required before processing a multisig tx.
       **/
      multiSigSignsRequired: AugmentedQuery<ApiType, (arg: AccountId | string | Uint8Array) => Observable<u64>, [AccountId]>;
      /**
       * Maps a multisig account to its identity.
       **/
      multiSigToIdentity: AugmentedQuery<ApiType, (arg: AccountId | string | Uint8Array) => Observable<IdentityId>, [AccountId]>;
      /**
       * Number of transactions proposed in a multisig. Used as tx id; starts from 0.
       **/
      multiSigTxDone: AugmentedQuery<ApiType, (arg: AccountId | string | Uint8Array) => Observable<u64>, [AccountId]>;
      /**
       * Number of approved/accepted signers of a multisig.
       **/
      numberOfSigners: AugmentedQuery<ApiType, (arg: AccountId | string | Uint8Array) => Observable<u64>, [AccountId]>;
      /**
       * Details of a multisig proposal
       **/
      proposalDetail: AugmentedQuery<ApiType, (arg: ITuple<[AccountId, u64]> | [AccountId | string | Uint8Array, u64 | AnyNumber | Uint8Array]) => Observable<ProposalDetails>, [ITuple<[AccountId, u64]>]>;
      /**
       * A mapping of proposals to their IDs.
       **/
      proposalIds: AugmentedQueryDoubleMap<ApiType, (key1: AccountId | string | Uint8Array, key2: Proposal | { callIndex?: any; args?: any } | string | Uint8Array) => Observable<Option<u64>>, [AccountId, Proposal]>;
      /**
       * Proposals presented for voting to a multisig (multisig, proposal id) => Option<T::Proposal>.
       **/
      proposals: AugmentedQuery<ApiType, (arg: ITuple<[AccountId, u64]> | [AccountId | string | Uint8Array, u64 | AnyNumber | Uint8Array]) => Observable<Option<Proposal>>, [ITuple<[AccountId, u64]>]>;
      /**
       ...
       **/
      votes: AugmentedQuery<ApiType, (arg: ITuple<[AccountId, Signatory, u64]> | [AccountId | string | Uint8Array, Signatory | { Identity: any } | { Account: any } | string | Uint8Array, u64 | AnyNumber | Uint8Array]) => Observable<bool>, [ITuple<[AccountId, Signatory, u64]>]>;
    };
    offences: {
      /**
    ...
    pips: {
       ...
       **/
      deposits: AugmentedQueryDoubleMap<ApiType, (key1: PipId | AnyNumber | Uint8Array, key2: AccountId | string | Uint8Array) => Observable<DepositInfo>, [PipId, AccountId]>;
      /**
       ...
       **/
      pipSkipCount: AugmentedQuery<ApiType, (arg: PipId | AnyNumber | Uint8Array) => Observable<SkippedCount>, [PipId]>;
      /**
       * Maps PIPs to the block at which they will be executed, if any.
       **/
      pipToSchedule: AugmentedQuery<ApiType, (arg: PipId | AnyNumber | Uint8Array) => Observable<Option<BlockNumber>>, [PipId]>;
      /**
       * The metadata of the active proposals.
       **/
      proposalMetadata: AugmentedQuery<ApiType, (arg: PipId | AnyNumber | Uint8Array) => Observable<Option<PipsMetadata>>, [PipId]>;
      /**
       * PolymeshVotes on a given proposal, if it is ongoing.
       * proposal id -> vote count
       **/
      proposalResult: AugmentedQuery<ApiType, (arg: PipId | AnyNumber | Uint8Array) => Observable<VotingResult>, [PipId]>;
      /**
       * Actual proposal for a given id, if it's current.
       * proposal id -> proposal
       **/
      proposals: AugmentedQuery<ApiType, (arg: PipId | AnyNumber | Uint8Array) => Observable<Option<Pip>>, [PipId]>;
      /**
       * Votes per Proposal and account. Used to avoid double vote issue.
       * (proposal id, account) -> Vote
       **/
      proposalVotes: AugmentedQueryDoubleMap<ApiType, (key1: PipId | AnyNumber | Uint8Array, key2: AccountId | string | Uint8Array) => Observable<Option<Vote>>, [PipId, AccountId]>;
      /**
    ...
    polymeshCommittee: {
       ...
       **/
      proposalOf: AugmentedQuery<ApiType, (arg: Hash | string | Uint8Array) => Observable<Option<Call>>, [Hash]>;
      /**
       ...
       * PolymeshVotes on a given proposal, if it is ongoing.
       **/
      voting: AugmentedQuery<ApiType, (arg: Hash | string | Uint8Array) => Observable<Option<PolymeshVotes>>, [Hash]>;
    };
    portfolio: {
      /**
       * The next portfolio sequence number of an identity.
       **/
      nextPortfolioNumber: AugmentedQuery<ApiType, (arg: IdentityId | string | Uint8Array) => Observable<PortfolioNumber>, [IdentityId]>;
      /**
       * The asset balances of portfolios.
       **/
      portfolioAssetBalances: AugmentedQueryDoubleMap<ApiType, (key1: PortfolioId | { did?: any; kind?: any } | string | Uint8Array, key2: Ticker | string | Uint8Array) => Observable<Balance>, [PortfolioId, Ticker]>;
      /**
       * The custodian of a particular portfolio. None implies that the identity owner is the custodian.
       **/
      portfolioCustodian: AugmentedQuery<ApiType, (arg: PortfolioId | { did?: any; kind?: any } | string | Uint8Array) => Observable<Option<IdentityId>>, [PortfolioId]>;
      /**
       * Amount of assets locked in a portfolio.
       * These assets show up in portfolio balance but can not be transferred away.
       **/
      portfolioLockedAssets: AugmentedQueryDoubleMap<ApiType, (key1: PortfolioId | { did?: any; kind?: any } | string | Uint8Array, key2: Ticker | string | Uint8Array) => Observable<Balance>, [PortfolioId, Ticker]>;
      /**
       ...
       **/
      portfolios: AugmentedQueryDoubleMap<ApiType, (key1: IdentityId | string | Uint8Array, key2: PortfolioNumber | AnyNumber | Uint8Array) => Observable<PortfolioName>, [IdentityId, PortfolioNumber]>;
      /**
       ...
       **/
      portfoliosInCustody: AugmentedQueryDoubleMap<ApiType, (key1: IdentityId | string | Uint8Array, key2: PortfolioId | { did?: any; kind?: any } | string | Uint8Array) => Observable<bool>, [IdentityId, PortfolioId]>;
      /**
       * Storage version.
       **/
      storageVersion: AugmentedQuery<ApiType, () => Observable<Version>, []>;
    ...
    settlement: {
       ...
       **/
      affirmsReceived: AugmentedQueryDoubleMap<ApiType, (key1: u64 | AnyNumber | Uint8Array, key2: PortfolioId | { did?: any; kind?: any } | string | Uint8Array) => Observable<AffirmationStatus>, [u64, PortfolioId]>;
      /**
       ...
       **/
      instructionDetails: AugmentedQuery<ApiType, (arg: u64 | AnyNumber | Uint8Array) => Observable<Instruction>, [u64]>;
      /**
       * Legs under an instruction. (instruction_id, leg_id) -> Leg
       **/
      instructionLegs: AugmentedQueryDoubleMap<ApiType, (key1: u64 | AnyNumber | Uint8Array, key2: u64 | AnyNumber | Uint8Array) => Observable<Leg>, [u64, u64]>;
      /**
       * Status of a leg under an instruction. (instruction_id, leg_id) -> LegStatus
       **/
      instructionLegStatus: AugmentedQueryDoubleMap<ApiType, (key1: u64 | AnyNumber | Uint8Array, key2: u64 | AnyNumber | Uint8Array) => Observable<LegStatus>, [u64, u64]>;
      /**
       * Tracks redemption of receipts. (signer, receipt_uid) -> receipt_used
       **/
      receiptsUsed: AugmentedQueryDoubleMap<ApiType, (key1: AccountId | string | Uint8Array, key2: u64 | AnyNumber | Uint8Array) => Observable<bool>, [AccountId, u64]>;
      /**
       * Storage version.
       **/
      storageVersion: AugmentedQuery<ApiType, () => Observable<Version>, []>;
       ...
       **/
      userAffirmations: AugmentedQueryDoubleMap<ApiType, (key1: PortfolioId | { did?: any; kind?: any } | string | Uint8Array, key2: u64 | AnyNumber | Uint8Array) => Observable<AffirmationStatus>, [PortfolioId, u64]>;
      /**
       * Array of venues created by an identity. Only needed for the UI. IdentityId -> Vec<venue_id>
       **/
      userVenues: AugmentedQuery<ApiType, (arg: IdentityId | string | Uint8Array) => Observable<Vec<u64>>, [IdentityId]>;
      /**
       ...
       **/
      venueAllowList: AugmentedQueryDoubleMap<ApiType, (key1: Ticker | string | Uint8Array, key2: u64 | AnyNumber | Uint8Array) => Observable<bool>, [Ticker, u64]>;
      /**
       ...
       **/
      venueFiltering: AugmentedQuery<ApiType, (arg: Ticker | string | Uint8Array) => Observable<bool>, [Ticker]>;
      /**
       * Info about a venue. venue_id -> venue_details
       **/
      venueInfo: AugmentedQuery<ApiType, (arg: u64 | AnyNumber | Uint8Array) => Observable<Option<Venue>>, [u64]>;
      /**
       * Signers allowed by the venue. (venue_id, signer) -> bool
       **/
      venueSigners: AugmentedQueryDoubleMap<ApiType, (key1: u64 | AnyNumber | Uint8Array, key2: AccountId | string | Uint8Array) => Observable<bool>, [u64, AccountId]>;
    };
    staking: {
      /**
       ...
       **/
      permissionedIdentity: AugmentedQuery<ApiType, (arg: IdentityId | string | Uint8Array) => Observable<Option<PermissionedIdentityPrefs>>, [IdentityId]>;
      /**
    ...
    statistics: {
       ...
       **/
      activeTransferManagers: AugmentedQuery<ApiType, (arg: Ticker | string | Uint8Array) => Observable<Vec<TransferManager>>, [Ticker]>;
      /**
       ...
       **/
      exemptEntities: AugmentedQueryDoubleMap<ApiType, (key1: ITuple<[Ticker, TransferManager]> | [Ticker | string | Uint8Array, TransferManager | { CountTransferManager: any } | { PercentageTransferManager: any } | string | Uint8Array], key2: ScopeId | string | Uint8Array) => Observable<bool>, [ITuple<[Ticker, TransferManager]>, ScopeId]>;
      /**
       * Number of current investors in an asset.
       **/
      investorCountPerAsset: AugmentedQuery<ApiType, (arg: Ticker | string | Uint8Array) => Observable<Counter>, [Ticker]>;
    };
    sto: {
      /**
       * Total fundraisers created for a token.
       **/
      fundraiserCount: AugmentedQuery<ApiType, (arg: Ticker | string | Uint8Array) => Observable<u64>, [Ticker]>;
      /**
       * Name for the Fundraiser. It is only used offchain.
       * (ticker, fundraiser_id) -> Fundraiser name
       **/
      fundraiserNames: AugmentedQueryDoubleMap<ApiType, (key1: Ticker | string | Uint8Array, key2: u64 | AnyNumber | Uint8Array) => Observable<FundraiserName>, [Ticker, u64]>;
      /**
       * All fundraisers that are currently running.
       * (ticker, fundraiser_id) -> Fundraiser
       **/
      fundraisers: AugmentedQueryDoubleMap<ApiType, (key1: Ticker | string | Uint8Array, key2: u64 | AnyNumber | Uint8Array) => Observable<Option<Fundraiser>>, [Ticker, u64]>;
    };
    sudo: {
      /**
    ...
    utility: {
      nonces: AugmentedQuery<ApiType, (arg: AccountId | string | Uint8Array) => Observable<AuthorizationNonce>, [AccountId]>;
    };
  }
