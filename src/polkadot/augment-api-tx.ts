...
declare module '@polkadot/api/types/submittable' {
  export interface AugmentedSubmittables<ApiType> {
    ...
    portfolio: {
       ...
       * * Portfolio
       **/
      quitPortfolioCustody: AugmentedSubmittable<(portfolioId: PortfolioId | { did?: any; kind?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [PortfolioId]>;
      /**
