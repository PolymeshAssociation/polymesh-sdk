 ...
 */
export class ConfidentialProcedure<
  Args = void,
  ReturnValue = void,
  Storage = Record<string, unknown>
> {
  private prepareTransactions: (
    this: ConfidentialProcedure<Args, ReturnValue, Storage>,
    args: Args
  ...
  private getAuthorization: (
    this: ConfidentialProcedure<Args, ReturnValue, Storage>,
    args: Args
  ) => Promise<ConfidentialProcedureAuthorization> | ConfidentialProcedureAuthorization;
  ...
  constructor(
    ...
    getAuthorization:
      ...
      | ((
          ...
          | ConfidentialProcedureAuthorization) = async (): Promise<ConfidentialProcedureAuthorization> => ({}),
    prepareStorage: (
      this: ConfidentialProcedure<Args, ReturnValue, Storage>,
      args: Args
    ...
    if (typeof getAuthorization !== 'function') {
      this.getAuthorization = (): ConfidentialProcedureAuthorization => getAuthorization;
    } else {
  ...
  private async _checkAuthorization(
    ...
    let rolesResult: ConfidentialCheckRolesResult;
    ...
    if (typeof roles === 'boolean') {
      ...
      if (identity) {
        rolesResult = await checkConfidentialRoles(identity, roles, context);
      }
    }
    ...
    if (typeof signerPermissions === 'boolean') {
      ...
      signerPermissionsAwaitable = checkConfidentialPermissions(account, signerPermissions);
    }
