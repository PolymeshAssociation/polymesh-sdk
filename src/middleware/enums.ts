...
export {
  ...
  PublicEnum5Df0F1D22C as BalanceTypeEnum,
  PublicEnum6E6395Eda7 as ProposalStateEnum,
  PublicEnum7A0B4Cc03E as ModuleIdEnum,
  PublicEnum8F5A39C8Ee as EventIdEnum,
...
export const middlewareEnumMap: Record<string, string> = {
  ...
  BalanceTypeEnum: 'PublicEnum5Df0F1D22C',
  ProposalStateEnum: 'PublicEnum6E6395Eda7',
  ModuleIdEnum: 'PublicEnum7A0B4Cc03E',
  EventIdEnum: 'PublicEnum8F5A39C8Ee',
  ...
  ClaimTypeEnum: 'PublicEnumEc3243D777',
};
