...
export class Assets {
   ...
   *   exists with the Asset ID it encodes, or if it is the ERC-20 address of an NFT collection or
   *   the ERC-721 address of a fungible Asset (neither answers on chain)
   */
