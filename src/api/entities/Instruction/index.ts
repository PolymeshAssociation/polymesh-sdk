...
import { InstructionAuthorizations, InstructionDetails, InstructionType, Leg } from './types';
...
export class Instruction extends Entity<UniqueIdentifiers> {
   ...
   */
  public async getAuthorizations(): Promise<InstructionAuthorizations[]> {
    const {
      context: {
        polymeshApi: {
          query: { settlement },
    ...
    const instructionAuthorizations: InstructionAuthorizations[] = [];
