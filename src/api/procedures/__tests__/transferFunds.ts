...
describe('transferFunds procedure', () => {
  ...
  describe('prepareTransferFunds', () => {
    ...
    it('should throw an error if a non-owning Account tries to transfer NFTs on a chain without NFT approvals', async () => {
      ...
      await expect(
        ...
        'The connected chain does not support NFT approvals, so only the owning key can transfer NFTs from an Account'
      );
    });
