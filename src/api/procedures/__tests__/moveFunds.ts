...
describe('moveFunds procedure', () => {
  ...
  it('should throw an error if some of the amount Asset to move exceeds its balance', async () => {
    ...
    entityMockUtils.configureMocks({
      numberedPortfolioOptions: {
        getAssetBalances: [
          { asset: asset1, total: new BigNumber(60), locked: new BigNumber(10) },
          { asset: asset2, total: new BigNumber(10), locked: new BigNumber(0) },
  ...
  it('should return a move portfolio funds transaction spec', async () => {
    ...
    entityMockUtils.configureMocks({
      numberedPortfolioOptions: {
        did,
        getAssetBalances: [
          { asset, total: new BigNumber(150), locked: new BigNumber(0) },
        ] as unknown as PortfolioBalance[],
        getCollections: [],
      },
      defaultPortfolioOptions: {
