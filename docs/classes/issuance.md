...
*Defined in [src/api/entities/SecurityToken/Issuance.ts:16](https://github.com/PolymathNetwork/polymesh-sdk/blob/ffcdfce/src/api/entities/SecurityToken/Issuance.ts#L16)*
