...
*Defined in [src/api/entities/Proposal/index.ts:51](https://github.com/PolymathNetwork/polymesh-sdk/blob/deb40bf/src/api/entities/Proposal/index.ts#L51)*
...
*Defined in [src/api/entities/Proposal/index.ts:154](https://github.com/PolymathNetwork/polymesh-sdk/blob/deb40bf/src/api/entities/Proposal/index.ts#L154)*
...
*Defined in [src/api/entities/Proposal/index.ts:146](https://github.com/PolymathNetwork/polymesh-sdk/blob/deb40bf/src/api/entities/Proposal/index.ts#L146)*
...
*Defined in [src/api/entities/Proposal/index.ts:162](https://github.com/PolymathNetwork/polymesh-sdk/blob/deb40bf/src/api/entities/Proposal/index.ts#L162)*
...
*Defined in [src/api/entities/Proposal/index.ts:188](https://github.com/PolymathNetwork/polymesh-sdk/blob/deb40bf/src/api/entities/Proposal/index.ts#L188)*
...
*Defined in [src/api/entities/Proposal/index.ts:104](https://github.com/PolymathNetwork/polymesh-sdk/blob/deb40bf/src/api/entities/Proposal/index.ts#L104)*
...
*Defined in [src/api/entities/Proposal/index.ts:69](https://github.com/PolymathNetwork/polymesh-sdk/blob/deb40bf/src/api/entities/Proposal/index.ts#L69)*
...
*Defined in [src/api/entities/Proposal/index.ts:233](https://github.com/PolymathNetwork/polymesh-sdk/blob/deb40bf/src/api/entities/Proposal/index.ts#L233)*
...
▸ **vote**(`args`: [VoteProposalParams](../globals.md#voteproposalparams)): *Promise‹[TransactionQueue](transactionqueue.md)‹void››*

*Defined in [src/api/entities/Proposal/index.ts:225](https://github.com/PolymathNetwork/polymesh-sdk/blob/deb40bf/src/api/entities/Proposal/index.ts#L225)*
...
Name | Type |
------ | ------ |
`args` | [VoteProposalParams](../globals.md#voteproposalparams) |
