...
Ƭ **MultiSigProposalVote**: [`EventIdentifier`](../wiki/types.EventIdentifier) & { `action`: [`MultiSigProposalVoteActionEnum`](../wiki/types.MultiSigProposalVoteActionEnum) ; `signer`: [`Signer`](../wiki/types#signer)  }

#### Defined in

[api/entities/MultiSigProposal/types.ts:55](https://github.com/PolymeshAssociation/polymesh-sdk/blob/2c78f6c3/src/api/entities/MultiSigProposal/types.ts#L55)
