...
- [AffirmOrWithdrawInstructionParams](../wiki/types#affirmorwithdrawinstructionparams)
...
- [SpWeightV2](../wiki/types.SpWeightV2)
...
Re-exports [AffirmOrWithdrawInstructionParams](../wiki/api.procedures.types#affirmorwithdrawinstructionparams)
...
[types/index.ts:774](https://github.com/PolymeshAssociation/polymesh-sdk/blob/2c78f6c3/src/types/index.ts#L774)
...
[types/index.ts:1161](https://github.com/PolymeshAssociation/polymesh-sdk/blob/2c78f6c3/src/types/index.ts#L1161)

___

### AnyJson

Ƭ **AnyJson**: `string` \| `number` \| `boolean` \| ``null`` \| `undefined` \| [`AnyJson`](../wiki/types#anyjson)[] \| { `[index: string]`: [`AnyJson`](../wiki/types#anyjson);  }

Represents JSON serializable data. Used for cases when the value can take on many types, like args for a MultiSig proposal.

#### Defined in

[types/index.ts:1738](https://github.com/PolymeshAssociation/polymesh-sdk/blob/2c78f6c3/src/types/index.ts#L1738)
...
| Name | Type |
| :------ | :------ |
| `type` | [`AttestPrimaryKeyRotation`](../wiki/types.AuthorizationType#attestprimarykeyrotation) |
| `value` | [`Identity`](../wiki/api.entities.Identity.Identity) |

#### Defined in

[types/index.ts:1132](https://github.com/PolymeshAssociation/polymesh-sdk/blob/2c78f6c3/src/types/index.ts#L1132)

___

### Authorization

Ƭ **Authorization**: [`AttestPrimaryKeyRotationAuthorizationData`](../wiki/types#attestprimarykeyrotationauthorizationdata) \| [`RotatePrimaryKeyAuthorizationData`](../wiki/types#rotateprimarykeyauthorizationdata) \| [`JoinIdentityAuthorizationData`](../wiki/types#joinidentityauthorizationdata) \| [`PortfolioCustodyAuthorizationData`](../wiki/types#portfoliocustodyauthorizationdata) \| [`BecomeAgentAuthorizationData`](../wiki/types#becomeagentauthorizationdata) \| [`AddRelayerPayingKeyAuthorizationData`](../wiki/types#addrelayerpayingkeyauthorizationdata) \| [`RotatePrimaryKeyToSecondaryData`](../wiki/types#rotateprimarykeytosecondarydata) \| [`GenericAuthorizationData`](../wiki/types#genericauthorizationdata)

Authorization request data corresponding to type

#### Defined in

[types/index.ts:1182](https://github.com/PolymeshAssociation/polymesh-sdk/blob/2c78f6c3/src/types/index.ts#L1182)
...
[types/index.ts:1156](https://github.com/PolymeshAssociation/polymesh-sdk/blob/2c78f6c3/src/types/index.ts#L1156)
...
[types/index.ts:308](https://github.com/PolymeshAssociation/polymesh-sdk/blob/2c78f6c3/src/types/index.ts#L308)
...
[types/index.ts:1458](https://github.com/PolymeshAssociation/polymesh-sdk/blob/2c78f6c3/src/types/index.ts#L1458)
...
[types/index.ts:471](https://github.com/PolymeshAssociation/polymesh-sdk/blob/2c78f6c3/src/types/index.ts#L471)
...
[types/index.ts:1730](https://github.com/PolymeshAssociation/polymesh-sdk/blob/2c78f6c3/src/types/index.ts#L1730)

___

### CustomClaimTypeWithDid

Ƭ **CustomClaimTypeWithDid**: [`CustomClaimType`](../wiki/types#customclaimtype) & { `did?`: `string`  }

CustomClaimType with DID that registered the CustomClaimType

#### Defined in

[types/index.ts:1760](https://github.com/PolymeshAssociation/polymesh-sdk/blob/2c78f6c3/src/types/index.ts#L1760)
...
[types/index.ts:1678](https://github.com/PolymeshAssociation/polymesh-sdk/blob/2c78f6c3/src/types/index.ts#L1678)
...
[types/index.ts:1039](https://github.com/PolymeshAssociation/polymesh-sdk/blob/2c78f6c3/src/types/index.ts#L1039)
...
[types/index.ts:479](https://github.com/PolymeshAssociation/polymesh-sdk/blob/2c78f6c3/src/types/index.ts#L479)
...
[types/index.ts:442](https://github.com/PolymeshAssociation/polymesh-sdk/blob/2c78f6c3/src/types/index.ts#L442)
...
[types/index.ts:1661](https://github.com/PolymeshAssociation/polymesh-sdk/blob/2c78f6c3/src/types/index.ts#L1661)
...
[types/index.ts:1671](https://github.com/PolymeshAssociation/polymesh-sdk/blob/2c78f6c3/src/types/index.ts#L1671)
...
[types/index.ts:505](https://github.com/PolymeshAssociation/polymesh-sdk/blob/2c78f6c3/src/types/index.ts#L505)
...
[types/index.ts:336](https://github.com/PolymeshAssociation/polymesh-sdk/blob/2c78f6c3/src/types/index.ts#L336)
...
[types/index.ts:341](https://github.com/PolymeshAssociation/polymesh-sdk/blob/2c78f6c3/src/types/index.ts#L341)
...
[types/index.ts:418](https://github.com/PolymeshAssociation/polymesh-sdk/blob/2c78f6c3/src/types/index.ts#L418)

___

### InstructionsByStatus

Ƭ **InstructionsByStatus**: [`GroupedInstructions`](../wiki/types.GroupedInstructions) & { `partiallyAffirmed`: [`Instruction`](../wiki/api.entities.Instruction.Instruction)[]  }

#### Defined in

[types/index.ts:1604](https://github.com/PolymeshAssociation/polymesh-sdk/blob/2c78f6c3/src/types/index.ts#L1604)
...
[types/index.ts:1146](https://github.com/PolymeshAssociation/polymesh-sdk/blob/2c78f6c3/src/types/index.ts#L1146)
...
[types/index.ts:1715](https://github.com/PolymeshAssociation/polymesh-sdk/blob/2c78f6c3/src/types/index.ts#L1715)
...
[middleware/typesV1.ts:9](https://github.com/PolymeshAssociation/polymesh-sdk/blob/2c78f6c3/src/middleware/typesV1.ts#L9)
...
[types/index.ts:1541](https://github.com/PolymeshAssociation/polymesh-sdk/blob/2c78f6c3/src/types/index.ts#L1541)
...
[types/index.ts:781](https://github.com/PolymeshAssociation/polymesh-sdk/blob/2c78f6c3/src/types/index.ts#L781)
...
| :------ | :------ | :------ |
| `asset` | [`NftCollection`](../wiki/api.entities.Asset.NonFungible.NftCollection.NftCollection) \| `string` | - |
| `memo?` | `string` | identifier string to help differentiate transfers |
| `nfts` | ([`Nft`](../wiki/api.entities.Asset.NonFungible.Nft.Nft) \| `BigNumber`)[] | - |

#### Defined in

[types/index.ts:1311](https://github.com/PolymeshAssociation/polymesh-sdk/blob/2c78f6c3/src/types/index.ts#L1311)
...
[types/index.ts:835](https://github.com/PolymeshAssociation/polymesh-sdk/blob/2c78f6c3/src/types/index.ts#L835)

___

### PermissionsLike

Ƭ **PermissionsLike**: { `assets?`: [`SectionPermissions`](../wiki/types.SectionPermissions)<`string` \| [`FungibleAsset`](../wiki/api.entities.Asset.Fungible.FungibleAsset)\> \| ``null`` ; `portfolios?`: [`SectionPermissions`](../wiki/types.SectionPermissions)<[`PortfolioLike`](../wiki/types#portfoliolike)\> \| ``null``  } & { `transactions?`: [`TransactionPermissions`](../wiki/types.TransactionPermissions) \| ``null``  } \| { `transactionGroups?`: [`TxGroup`](../wiki/types.TxGroup)[]  }
...
[types/index.ts:1281](https://github.com/PolymeshAssociation/polymesh-sdk/blob/2c78f6c3/src/types/index.ts#L1281)
...
[types/index.ts:1151](https://github.com/PolymeshAssociation/polymesh-sdk/blob/2c78f6c3/src/types/index.ts#L1151)
...
[types/index.ts:1267](https://github.com/PolymeshAssociation/polymesh-sdk/blob/2c78f6c3/src/types/index.ts#L1267)

___

### PortfolioMovement

Ƭ **PortfolioMovement**: [`FungiblePortfolioMovement`](../wiki/types.FungiblePortfolioMovement) \| [`NonFungiblePortfolioMovement`](../wiki/types#nonfungibleportfoliomovement)

#### Defined in

[types/index.ts:1320](https://github.com/PolymeshAssociation/polymesh-sdk/blob/2c78f6c3/src/types/index.ts#L1320)
...
[types/index.ts:1647](https://github.com/PolymeshAssociation/polymesh-sdk/blob/2c78f6c3/src/types/index.ts#L1647)
...
[types/index.ts:137](https://github.com/PolymeshAssociation/polymesh-sdk/blob/2c78f6c3/src/types/index.ts#L137)
...
[types/index.ts:1137](https://github.com/PolymeshAssociation/polymesh-sdk/blob/2c78f6c3/src/types/index.ts#L1137)
...
[types/index.ts:1141](https://github.com/PolymeshAssociation/polymesh-sdk/blob/2c78f6c3/src/types/index.ts#L1141)
...
[middleware/types.ts:13](https://github.com/PolymeshAssociation/polymesh-sdk/blob/2c78f6c3/src/middleware/types.ts#L13)

___

### ScopedClaim

Ƭ **ScopedClaim**: [`JurisdictionClaim`](../wiki/types.JurisdictionClaim) \| [`AccreditedClaim`](../wiki/types.AccreditedClaim) \| [`AffiliateClaim`](../wiki/types.AffiliateClaim) \| [`BuyLockupClaim`](../wiki/types.BuyLockupClaim) \| [`SellLockupClaim`](../wiki/types.SellLockupClaim) \| [`KycClaim`](../wiki/types.KycClaim) \| [`ExemptedClaim`](../wiki/types.ExemptedClaim) \| [`BlockedClaim`](../wiki/types.BlockedClaim) \| [`CustomClaim`](../wiki/types.CustomClaim)

#### Defined in

[types/index.ts:295](https://github.com/PolymeshAssociation/polymesh-sdk/blob/2c78f6c3/src/types/index.ts#L295)
...
[types/index.ts:1249](https://github.com/PolymeshAssociation/polymesh-sdk/blob/2c78f6c3/src/types/index.ts#L1249)
...
[types/index.ts:319](https://github.com/PolymeshAssociation/polymesh-sdk/blob/2c78f6c3/src/types/index.ts#L319)
...
[types/index.ts:709](https://github.com/PolymeshAssociation/polymesh-sdk/blob/2c78f6c3/src/types/index.ts#L709)
...
[types/index.ts:1238](https://github.com/PolymeshAssociation/polymesh-sdk/blob/2c78f6c3/src/types/index.ts#L1238)
...
[types/index.ts:1682](https://github.com/PolymeshAssociation/polymesh-sdk/blob/2c78f6c3/src/types/index.ts#L1682)
...
[types/index.ts:1420](https://github.com/PolymeshAssociation/polymesh-sdk/blob/2c78f6c3/src/types/index.ts#L1420)

___

### UnscopedClaim

Ƭ **UnscopedClaim**: [`CddClaim`](../wiki/types.CddClaim)

#### Defined in

[types/index.ts:306](https://github.com/PolymeshAssociation/polymesh-sdk/blob/2c78f6c3/src/types/index.ts#L306)
...
[types/index.ts:711](https://github.com/PolymeshAssociation/polymesh-sdk/blob/2c78f6c3/src/types/index.ts#L711)
